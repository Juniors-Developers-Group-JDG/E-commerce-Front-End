...
const Product = ({
  ...
  return (
    <div className="border-[1px] border-solid border-[#879DB7] rounded-[10px] flex flex-col w-[15.25em] min-h-[20%] relative transition-all cursor-pointer hover:scale-[1.1]">
      {discount && (
