      ...
      <section className="w-full justify-start items-start inline-flex flex-row max-lg:flex-col">
        ...
        <div className="w-full h-32 flex-col justify-start items-start gap-2 inline-flex max-lg:h-fit max-xl:mb-[1em]">
          ...
          <div className="w-full text-black text-base font-normal flex alig">
            O Xbox Series X é o mais recente console de videogame da Microsoft,
            oferecendo gráficos impressionantes, desempenho de última geração e
            tempos de carregamento rápidos. Com uma ampla biblioteca de jogos
            exclusivos, suporte para jogos em 4K e HDR, além da compatibilidade
            com versões anteriores, o Xbox Series X proporciona uma experiência
            de jogo imersiva e envolvente. Desfrute de uma nova geração de jogos
            com o poderoso Xbox Series X.
          </div>
        </div>
      </section>
